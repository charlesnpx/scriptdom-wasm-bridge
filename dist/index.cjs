...
function normalizeOptions2(options) {
  ...
  const style = readOwnDataProperty2(options, "style");
  const prefix = readOwnDataProperty2(options, "prefix");
  const startAt = readOwnDataProperty2(options, "startAt");
  const avoidExisting = readOwnDataProperty2(options, "avoidExisting");
